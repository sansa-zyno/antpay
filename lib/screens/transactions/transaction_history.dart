...
class _TransactionHistoryState extends State<TransactionHistory> {
  ...
  getTransactionHistory(String token) async {
    Response response = await HttpService.getRequest(Api.transactionHistory, bearerToken: true, accessToken: token);
                    ...
                    child: Column(
                      children: [
                        ...
                        transactionHistory != null
                                    ...
                                    itemBuilder: (context, index) {
                                      return Card(
                                        child: ListTile(
                                            onTap: () async {},
                                            title: CustomText(
                                              text: transactionHistory![index]["type"].toString().capitalizeFirst!,
                                              size: 16,
                            ...
                            : Container(
                                height: MediaQuery.of(context).size.height - 150, alignment: Alignment.center, child: CircularProgressIndicator()),
                      ],
                    )),
              )
            ],
