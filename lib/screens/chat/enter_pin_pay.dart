...
import 'package:ant_pay/screens/success_alert.dart';
...
class PayEnterPin extends StatefulWidget {
  ...
  final String amount;
  final Future Function() sendSticker;
  final AppEntity conversationWith;
  PayEnterPin({required this.name, required this.validationUrl, required this.amount, required this.sendSticker, required this.conversationWith});
  @override
            ...
            Column(
              children: [
                ...
                Row(
                  children: [
                    ...
                    RichText(
                      ...
                      TextSpan(text: "Pay "),
                      TextSpan(style: TextStyle(color: gd2), text: " ${widget.name} "),
                      TextSpan(style: TextStyle(color: Colors.red), text: "\$${widget.amount}")
                    ])),
                    Spacer(),
                    SizedBox(
                      width: 30,
                ...
                Padding(
                  ...
                  child:
                      CustomText(text: "Enter your 4-digit Antpay PIN to approve this transfer ", color: Colors.white, textAlign: TextAlign.center),
                ),
                SizedBox(
                  height: 50,
                ),
                ...
                isLoading
                    ...
                    : GradientButton(
                        ...
                        widget.sendSticker().then((value) =>
                          ...
                          isLoading = true;
                          setState(() {});
                          Response response = await HttpService.postRequest(widget.validationUrl, {"_pin": pinController.text},
                              bearerToken: true, accessToken: appProvider.token, validationUrl: true);
                          ...
                          if (response.statusCode == 200) {
                            ...
                            if (res["status"]) {
                              widget.sendSticker().then((value) {
                                changeScreenReplacement(context, Success("Transfer"));
                              ...
                              isLoading = false;
                              setState(() {});
                              Get.defaultDialog(title: "Error", middleText: res["message"]);
                            }
                          } else {
                            isLoading = false;
                            setState(() {});
                            Get.defaultDialog(title: "Error", middleText: "An error occurred");
                          }
                        }),
                SizedBox(
                  height: 50,
