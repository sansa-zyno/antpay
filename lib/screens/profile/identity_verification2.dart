                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CustomText(
                          text: "Fill in the requied details as appeared on your valid ID ",
                          size: 12,
                          color: Colors.white,
                        ),
                      ],
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: ExpansionTile(
                                ...
                                title: Text(docType, style: TextStyle(color: Colors.grey, fontSize: 14)),
                                ...
                                children: [
                                  InkWell(
                                      ...
                                      child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              Text("National Id", style: TextStyle(color: a ? Colors.white : Colors.black)),
                                            ],
                                          ))),
                                  InkWell(
                                      onTap: () {
                                      ...
                                      child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              Text("International Passport", style: TextStyle(color: b ? Colors.white : Colors.black)),
                                            ],
                                          ))),
                                  InkWell(
                                      onTap: () {
                                      ...
                                      child: Container(
                                          ...
                                          child: Row(
                                            children: [
                                              Text("Driver's License", style: TextStyle(color: c ? Colors.white : Colors.black)),
                                            ],
                                          ))),
                                ],
                              )),
                              ...
                              : GradientButton(
                                  ...
                                  onpressed: () async {
                                    ...
                                    Response response = await HttpService.postRequest(
                                        Api.kyc, {"name": val.toLowerCase(), "id_number": bvnSsnController.text},
                                    ...
                                    if (result["status"]) {
                                      if (file != null) {
                                        try {
                                          dio.Response response = await HttpService.postWithFiles(Api.docVerification, {
                                            "attachment": dio.MultipartFile.fromBytes(File(file!.path!).readAsBytesSync(), filename: file!.name),
                                            "name": file!.name
                                          });
