...
import 'package:ant_pay/screens/fund/fund_account.dart';
import 'package:ant_pay/screens/transfer/send_to_beneficiary.dart';
import 'package:ant_pay/screens/transactions/transaction_history.dart';
import 'package:ant_pay/screens/withdraw/withdraw.dart';
import 'package:ant_pay/screens/wallet/wallet_settings.dart';
                  ...
                  children: [
                    Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [gd3, gd3], stops: [0.2, 0.6]),
                        ),
                              ...
                              /*Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      onTap: () {
                                        userController.getCurrentUser.isReadyForTxn! ? changeScreen(context, NewVirtualCard()) : {};
                                      },
                                      child: Row(
                                        children: [
                                          Icon(
                                    ...
                                    InkWell(
                                      onTap: () {
                                        userController.getCurrentUser.isReadyForTxn! ? changeScreen(context, NewCard()) : {};
                                      },
                                      child: Row(
                                        children: [
                                          Icon(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(color: gd2, borderRadius: BorderRadius.circular(8)),
                      child: Column(
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  appProvider.wallet != null
                                      ? CustomText(
                                          text: userController.getCurrentUser.isReadyForTxn!
                                              ? "\u20A6 ${appProvider.wallet!["balance"]}".replaceAllMapped(reg, mathFunc)
                                              : "Unavailabe",
                                          color: appColor,
                                          size: 16,
                                          weight: FontWeight.bold,
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    color: Colors.transparent, border: Border.all(color: appColor), borderRadius: BorderRadius.circular(8)),
                                child: CustomText(
                                  text: "Today's Rates",
                                  color: appColor,
                                ),
