...
import 'package:ant_pay/screens/auth/double_auth.dart';
import 'package:ant_pay/screens/profile/identity_verification2.dart';
import 'package:ant_pay/screens/auth/set_pin.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            /*userController.getCurrentUser.isReadyForTxn!
                                ? changeScreen(context, IdentityVerification2())
                                : changeScreen(
                                    context, IdentityVerification1());*/
                            changeScreen(context, IdentityVerification2());
                          },
                        ),
                        /* ListTile(
                        ...
                        ListTile(
                          ...
                          trailing: Switch(activeColor: Colors.white, activeTrackColor: appColor, value: true, onChanged: (x) {}),
                        ),
                        ListTile(
                          leading: Icon(
                            Icons.verified_user,
