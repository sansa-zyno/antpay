            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: CustomText(
                        text: "Set up a 5-digit Double authentication PIN,\n We’ll ask you for it from time to time", textAlign: TextAlign.center),
                  ),
                  SizedBox(
                    height: 50,
                  ),
                  ...
                  GradientButton(title: "Done", textClr: Colors.white, clrs: [appColor, appColor], onpressed: () {}),
                  SizedBox(
                    height: 50,
                  ),
                ],
