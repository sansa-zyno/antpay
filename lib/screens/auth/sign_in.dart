...
class SignIn extends StatefulWidget {
  ...
  SignIn({this.onpressed, this.phone});
                ...
                child: Column(
                  children: [
                            ...
                            onPressed: () {
                              showCountryPicker(
                                ...
                                onSelect: (Country country) {
                                  ...
                                  appProvider.setCountrySelected(country.displayName);
                                  appProvider.setDialCode("+${country.phoneCode}");
                                },
                              );
                            },
                            color: appColor),
                    ...
                    GradientButton(
                        ...
                        onpressed: () {
                          widget.onpressed!(appProvider.countrySelected, appProvider.dialcode);
                        }),
                  ],
                ),
              ),
