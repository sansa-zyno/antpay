...
import 'package:ant_pay/screens/transfer/enter_pin_send.dart';
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(color: Color(0xffADFFE1), borderRadius: BorderRadius.circular(8)),
                              child: Center(
                                child: CustomText(
                                  text: "Local",
                                  color: appColor,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: ListTile(
                                  title: Text(bankName.isEmpty ? "Select Bank" : bankName, style: TextStyle(color: Colors.grey, fontSize: 14)),
                                  trailing: IconButton(
                                    onPressed: () async {
                                                  ...
                                                  child: SingleChildScrollView(
                                                    child: Column(
                                                        children: List.generate(
                                                            appProvider.banks.length,
                                                            (index) => ListTile(
                                                                  onTap: () {
                                                                    bankId = appProvider.banks[index]["uid"];
                                                                    countryId = appProvider.banks[index]["country"]["uid"];
                                                                    bankName = appProvider.banks[index]["bank_name"];
                                                                    setState(() {});
                                                                    Navigator.pop(context);
                                                                  },
                                                                  leading: Text("${index + 1}"),
                                                                  title: Text(appProvider.banks[index]["bank_name"]),
                                                                ))),
                                                  ),
                                                )));
                                      } else {
                                    ...
                                    icon: Icon(Icons.arrow_drop_down, color: appColor),
                                  ),
                                )),
                            SizedBox(
                              height: 15,
                                  ...
                                  : InkWell(
                                      onTap: () async {
                                        ...
                                        Response response = await HttpService.postRequest(
                                            Api.nameEnquiry, {"account_number": recipientAccountNo.text, "bank_id": bankId},
                            ...
                            loading
                                ...
                                : GradientButton(
                                    ...
                                    clrs: confirmRecipient ? [appColor, appColor] : [gd5, gd5],
                                    onpressed: confirmRecipient
                                        ? () async {
                                            loading = true;
                                            setState(() {});
                                            dio.Response response = await HttpService.postFromDio(
                                                Api.withdraw,
                                                {
                                                  "account_number": recipientAccountNo.text,
                                                  "bank_id": bankId,
                                                  "country_id": countryId,
                                                  "narration": narrationController.text,
                                                  "amount": int.parse(amountController.text),
                                                  "save_beneficiary": addToBeneficiary
                                                },
