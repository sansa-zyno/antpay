...
class SendEnterPin extends StatefulWidget {
  final String validationUrl;
  SendEnterPin({required this.validationUrl});
  @override
  State<SendEnterPin> createState() => _SendEnterPinState();
}

class _SendEnterPinState extends State<SendEnterPin> {
            ...
            Column(
              children: [
                ...
                Padding(
                  ...
                  child: CustomText(
                      text: "Enter your 4-digit Antpay PIN to approve this transaction ", color: Colors.white, textAlign: TextAlign.center),
                ),
                SizedBox(
                  height: 50,
                ),
                        ...
                        onpressed: () async {
                          ...
                          if (response.statusCode == 200) {
                            ...
                            if (res["status"]) {
                              ...
                              changeScreenReplacement(context, Success("Transaction"));
                            } else {
                              isLoading = false;
                              setState(() {});
                              Get.defaultDialog(title: "Error", titleStyle: TextStyle(color: Colors.red), middleText: res["message"]);
                            }
                          } else {
                            isLoading = false;
                            setState(() {});
