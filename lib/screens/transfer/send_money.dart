              ...
              Expanded(
                child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [gd2, gd3], stops: [0.2, 0.6])),
                    child: Column(
                      children: [
                        SizedBox(
                          height: 50,
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                gradient: LinearGradient(
                                    ...
                                    colors: [Color(0xff25D366), Color(0xff25D366).withOpacity(0.3), Color(0xffFFFFFF)]),
                                  ...
                                  children: [
                                    ...
                                    RichText(
                                        text: TextSpan(
                                            ...
                                            children: [TextSpan(text: "Send to Bank \n"), TextSpan(text: "Account")])),
                                    SizedBox(
                                      width: 15,
                                    ),
                                ...
                                children: [
                                  ...
                                  RichText(
                                      text: TextSpan(
                                          ...
                                          children: [TextSpan(text: "Send to Virtual \n"), TextSpan(text: "Account")])),
                                  SizedBox(
                                    width: 15,
                                  ),
                                  Image.asset(
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    gradient: LinearGradient(
                                        ...
                                        colors: [Color(0xff25D366), Color(0xff25D366), Color(0xffFFFFFF)]),
                                    borderRadius: BorderRadius.only(
                                        topLeft: Radius.circular(50),
                                        bottomLeft: Radius.circular(50),
                                        topRight: Radius.circular(8),
