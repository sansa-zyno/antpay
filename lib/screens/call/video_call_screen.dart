...
class _VideoCallScreenState extends State<VideoCallScreen> {
  ...
  Widget _toolbar() {
    return Container(
      ...
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), color: appColor.withOpacity(0.3)),
      child: Row(
      ...
      decoration: _remoteUid == null
          ? BoxDecoration(
              image: DecorationImage(
                  image: widget.call.hasDialled! ? NetworkImage(widget.call.receiverPic!) : NetworkImage(widget.call.receiverPic!),
                  fit: BoxFit.cover,
                  opacity: 0.15),
            )
          : null,
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                widget.call.hasDialled == true ? widget.call.receiverName! : widget.call.callerName!,
                                style: TextStyle(
