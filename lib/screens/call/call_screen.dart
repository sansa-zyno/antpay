                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            padding: EdgeInsets.symmetric(horizontal: 10, vertical: 8),
                            decoration: BoxDecoration(color: Color(0xffADFFE1), borderRadius: BorderRadius.circular(15)),
                            child: CustomText(
                              text: "View all",
                              color: Colors.black,
                              size: 14,
                              ...
                              ? snapshot.data!.docs.isNotEmpty
                                  ? ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        User recipient = snapshot.data!.docs[index]["has_dialled"]
                                            ? User(
                                                uid: snapshot.data!.docs[index]["receiver_id"].toString().toLowerCase(),
                                                name: snapshot.data!.docs[index]["receiver_name"],
                                                avatar: snapshot.data!.docs[index]["receiver_pic"])
                                            : User(
                                                uid: snapshot.data!.docs[index]["caller_id"].toString().toLowerCase(),
                                                name: snapshot.data!.docs[index]["caller_name"],
                                                avatar: snapshot.data!.docs[index]["caller_pic"]);
                                        return ListTile(
                                          onTap: () async {
                                            await Permissions.cameraAndMicrophonePermissionsGranted()
                                                ? CallUtils.dialAudio(from: me, to: recipient, context: context)
                                                : {};
                                          },
                                          leading: Container(
                                            width: 50,
                                            decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                    image: snapshot.data!.docs[index]["has_dialled"]
                                                        ? NetworkImage(snapshot.data!.docs[index]["receiver_pic"])
                                                        : NetworkImage(snapshot.data!.docs[index]["caller_pic"]),
                                                    fit: BoxFit.cover)),
                                          ),
                                          title: snapshot.data!.docs[index]["has_dialled"]
                                              ? CustomText(text: "${snapshot.data!.docs[index]["receiver_name"]}")
                                              : CustomText(text: "${snapshot.data!.docs[index]["caller_name"]}"),
                                          subtitle: Row(
                                            children: [
                                              Icon(
                                                Icons.call,
                                              ...
                                              CustomText(
                                                text: snapshot.data!.docs[index]["status"] == "0" ? "Outgoing" : "incoming",
                                                size: 14,
                                              )
                                            ],
                                          ),
                                  ...
                                  : Center(child: Text("No call history to show"))
