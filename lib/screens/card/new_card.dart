          ...
          Container(
            ...
            child: Stack(
              children: [
                Positioned(
                  ...
                  child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(height: 30),
                          CustomText(text: "Card Number", color: appColor, weight: FontWeight.bold),
                          SizedBox(height: 8),
                          CurvedTextField(hint: "xxxx xxxx xxxx"),
                          SizedBox(height: 15),
                          Container(
                            width: 283,
                            child: Row(
                              ...
                              children: [
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    CustomText(text: "Expiry Date", color: appColor, weight: FontWeight.bold),
                                    SizedBox(height: 5),
                                    Container(
                                      height: 58,
                                      width: 130,
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      width: 130,
                                      child: Row(
                                          mainAxisAlignment: MainAxisAlignment.end, children: [CustomText(text: "What is cvv?", color: appColor)]),
                                    )
                                  ],
                                )
                              ],
                ...
                //Added here to prevent the hand image from covering the tap gestures
                Container(
                  height: 270,
                  width: double.infinity,
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Spacer(),
                          CustomText(text: "Add New Card", color: Colors.white, size: 16),
                          Spacer(),
                          SizedBox(width: 30),
                        ],
                      ),
