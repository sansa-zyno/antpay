                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Icon(Icons.arrow_back_ios_new, color: gd2, size: 20),
                        ),
                        Spacer(),
                        CustomText(text: "Create Virtual Card", color: Colors.white, size: 16),
                        SizedBox(height: 8),
                        Spacer(),
                        SizedBox(width: 30),
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        CustomText(text: "We’ll need some details to create your virtual card", color: Colors.white),
                      ],
                    ),
                    SizedBox(height: 15)
                  ],
                ...
                child: Container(
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          SizedBox(height: 15),
                          CustomText(text: "Full Name", color: appColor, weight: FontWeight.bold),
                          SizedBox(height: 5),
                          CurvedTextField(hint: ""),
                          SizedBox(height: 15),
                          CustomText(text: "Nickname", color: appColor, weight: FontWeight.bold),
                          SizedBox(height: 5),
                          CurvedTextField(hint: ""),
                          SizedBox(height: 15),
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    CustomText(text: "Date Of Birth", color: appColor, weight: FontWeight.bold),
                                    SizedBox(height: 5),
                                    InkWell(
                                      onTap: () async {
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          children: [SizedBox(width: 8), Icon(Icons.date_range), SizedBox(width: 8), CustomText(text: dob)],
                                        ),
                                      ),
                                    ),
                                  ],
                                ...
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    CustomText(text: "Sex", color: appColor, weight: FontWeight.bold),
                                    SizedBox(height: 5),
                                    Container(
                                      height: 58,
                                      width: 130,
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        title: Text("", style: TextStyle(color: Colors.grey, fontSize: 14)),
