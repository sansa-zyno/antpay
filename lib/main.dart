...
void main() async {
  ...
  CometChat.init(cometchatAppId, appSettings, onSuccess: (String successMessage) {
...
class _WrapperState extends State<Wrapper> {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(image: DecorationImage(image: AssetImage(stickers)), color: Color(0xff3F007B)),
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            Center(child: Image.asset("assets/images/splash_ant_native.png", width: 150)),
            //SizedBox(height: 100),
            /*Padding(
  ...
  /*Future<void> loginOnAntpay() async {
