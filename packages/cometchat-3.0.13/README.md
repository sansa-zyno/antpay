...
- Check the [key concepts](https://cometchat.com/docs/v3/flutter-chat-sdk/key-concepts) to understand the basic components of CometChat.
- Refer to the [Integration Steps](https://cometchat.com/docs/v3/flutter-chat-sdk/setup) in our documentation to integrate the SDK into your Flutter app.

## Help and Support
For issues running the project or integrating with our SDK, consult our [documentation](https://www.cometchat.com/docs/v3/flutter-chat-sdk/overview) or create a [support ticket](https://help.cometchat.com/hc/en-us) or seek real-time support via the [CometChat Dashboard](https://app.cometchat.com/).